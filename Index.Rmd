...
# swcrt <img src='reference/figures/logo.png' align="right" width="120"/>
...
X <- design_sw(clusters_per_wave = c(0, 1, 1, 1, 1),
               labels            = c("C", "I"))
```
Here, we've labelled the two conditions `"C"` and `"I"` to reflect their role as the control and intervention arms. The input `clusters_per_wave` is used to specify the design; a single cluster switches in time periods two through five.
...
<img src="reference/figures/example.png" height="300"/>
